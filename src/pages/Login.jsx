...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Using mock API for now - accepts any credentials
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-6 px-8">
          <div>
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Connect with entrepreneurs, mentors, and investors to grow your business.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Discover events, communities, and partnerships</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Grow Together</h3>
                <p className="text-gray-600 text-sm">Learn from experts and share your knowledge</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Sign in to continue to ThriveUnity</p>
          </div>
